  ...
  module V1
    class PetsController < ApplicationController
      ...
      def create
        ...
        if @pet.save
          render json: { status: 'success', message: 'Pet successfully created.', pet: @pet }, status: :created
        else
          render json: { status: 'error', message: @pet.errors.full_messages }, status: :unprocessable_entity
        end
      end
